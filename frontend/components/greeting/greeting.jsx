    ...
    <div>
      ...
      <section className="hero-section">
        <div className="hero-content">
          ...
          This Platform lets you invest in top athletes for free.
          </h3>
          <button
      ...
      <section className="design-section" onMouseEnter={animateDesign}>
        <div className="design-content" id="design-content">
          ...
          <h3 className="design-description">
            We've designed This Platform from the ground up{" "}
          </h3>
          <br />
          <h3 className="design-description">
      ...
      >
        <div className="security-content">
          ...
          <br />
          <h3 className="security-description">
          This Platform is a member of SPIC, which means securities in your
          </h3>
          <br />
          <h3 className="security-description">
      ...
      <footer>
        <hr />
        <a href="mailto:pradeep.rayapudi93@gmail.com">
          <img
        ...
        <p className="footer-text">
          Created by Pradeep Rao Rayapudi
        </p>
      </footer>
    </div>
  );
